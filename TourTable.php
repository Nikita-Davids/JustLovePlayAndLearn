...
function sendApprovalEmail($tourData)
{
    ...
    try {
        $mail->isSMTP();
        $mail->Host = 'mail.justloveplayandlearncentre.co.za';

        //Configure your SMTP settings here(see PHP Form Submit To Send Email Contact Form Submit to Email Using PHP,2021)
        $mail->SMTPAuth = true;
        $mail->Username = 'jlplayandlearncentre@justloveplayandlearncentre.co.za'; //Email of daycare(see PHP Form Submit To Send Email Contact Form Submit to Email Using PHP,2021)
        $mail->Password = 'JustLove2024!'; //Email password (GENERATED APP PASSWORD)(see PHP Form Submit To Send Email Contact Form Submit to Email Using PHP,2021)
        $mail->SMTPSecure = 'ssl';
        $mail->Port = 465;

        $mail->setFrom('jlplayandlearncentre@justloveplayandlearncentre.co.za');
